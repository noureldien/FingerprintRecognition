function [featureVector, gaborResult, gabourImage] = gaborFeatures(img,gaborArray,d1,d2)
...
% result image
gabourImage = zeros(n,m);
for i=1:u
    for j=1:v
        gabourImage = gabourImage + real(gaborResult{i,j});
    end
end
gabourImage = scaleImage(gabourImage, 0, 255);
